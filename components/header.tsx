      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:px-8">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          <Button asChild className="bg-[#25D366] text-white hover:bg-[#20bd5a]">
            <a href="https://wa.me/5511913307306?text=Olá, gostaria de uma avaliação gratuita do meu caso trabalhista." target="_blank" rel="noopener noreferrer">
      ...
      {mobileOpen && (
        <div className="border-t border-border bg-card px-4 pb-4 pt-2 lg:hidden">
          <nav className="flex flex-col gap-3">
            ...
            <Button asChild className="mt-1 w-full bg-accent text-accent-foreground hover:bg-accent/90">
              <a href="#formulario" onClick={() => setMobileOpen(false)}>Fale Conosco</a>
            </Button>
          </nav>
        </div>
      )}
